...
const MyHeader = ({title, image, navigation}) => {
  ...
  return (
    <header className="border-b-2 border-gray-200 shadow-md">
      <div className="flex justify-between py-4 mx-auto container-xl">
        ...
        <a onClick={() => setIsOpen(true)} className='flex items-center justify-center px-2 border-2 rounded-md bg-gradient-to-r from-secondary to-primary border-gray-50'>
